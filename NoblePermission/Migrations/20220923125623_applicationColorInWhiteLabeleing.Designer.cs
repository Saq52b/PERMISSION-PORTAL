...
namespace NoblePermission.Migrations
{
    ...
    [Migration("20220923125623_applicationColorInWhiteLabeleing")]
    partial class applicationColorInWhiteLabeleing
    {
            ...
            modelBuilder.Entity("NoblePermission.Persistance.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$11$RxtykGPRQKcDBiTKjrFvl.oRJihxr7GRDhZCu4ubhD/ZWisC.eygq",
                            UserName = "Permission"
                        });
                });
