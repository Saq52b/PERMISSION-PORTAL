...
namespace NoblePermission.Migrations
{
    ...
    [Migration("20220922123505_changingInWhiteLabeling")]
    partial class changingInWhiteLabeling
    {
            ...
            modelBuilder.Entity("NoblePermission.Persistance.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$11$IydABnwbF.ogNiqjvb6/8ee7q1PVVLweyz4J4XZ2AMILpZvTEG2kO",
                            UserName = "Permission"
                        });
                });
