...
namespace NoblePermission.Migrations
{
    ...
    [Migration("20220921070804_ColorChangeInWhiteLabeling")]
    partial class ColorChangeInWhiteLabeling
    {
            ...
            modelBuilder.Entity("NoblePermission.Persistance.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$11$PZbvc/yzWRnJ4AwjKogdNuzsAeJAUY20fRdB19P.UcCf0oJMxfx.m",
                            UserName = "Permission"
                        });
                });
            ...
            modelBuilder.Entity("NoblePermission.Persistance.Entities.WhiteLabelling", b =>
                {
                    ...
                    b.Property<string>("CloseBtnColor")
                        .HasColumnType("nvarchar(max)");
