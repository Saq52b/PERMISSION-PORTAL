...
namespace NoblePermission.Migrations
{
    ...
    [Migration("20220419100514_AddCompanyIdInCompanyPermission")]
    partial class AddCompanyIdInCompanyPermission
    {
            ...
            modelBuilder.Entity("NoblePermission.Persistance.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$11$F3WfYbpLzNbH.Hm/UqjsJOYRITAmk32t3KDSU.3Sr572upmjQRjbO",
                            UserName = "Permission"
                        });
                });
